  ...
  showVerticalList() {
    ...
    return (
      ...
      <ContentLoader width={'100%'} height={'800'}>
            ...
            <Rect x="0" y="130" width="100%" height="150"/>
            <Rect x="0" y="255" width="100%" height="150"/>
            <Rect x="0" y="380" width="100%" height="150"/>
      </ContentLoader>
      : 
      <List dataArray={this.state.articleData} renderRow={(item) =>
        ...
        <CardItem button
          ...
          onPress={() => navigate('ArticleDetail', {id: item.id, title: item.title})}
          >
          <Left>
