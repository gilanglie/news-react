    ...
    return (
      this.state.loading ? 
        <ContentLoader  height={500}>
          <Rect x="25" y="17" rx="5" ry="5" width="70" height="70"/>
          <Rect x="105" y="17" rx="4" ry="4" width="300" height="13"/>
          <Rect x="105" y="40" rx="3" ry="3" width="250" height="10"/>
          <Rect x="25" y="80" rx="3" ry="3" width="350" height="10"/>
          <Rect x="25" y="100" rx="3" ry="3" width="200" height="10"/>
          <Rect x="25" y="120" rx="3" ry="3" width="360" height="10"/>
        </ContentLoader>
      :
      <ScrollView>
          <Card>
