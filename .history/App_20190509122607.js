...
export default class App extends Component{
  ...
  // .badge-{background-color:#ff9f43}
  // .badge-lifestyle{background-color:#f368e0}
  // .badge-sport{background-color:#54a0ff}
  // .badge-tech{background-color:#5f27cd}
  // .badge-travel{background-color:#1dd1a1}
  ...
  showVerticalList() {
    return (
      <List dataArray={this.state.articleData} renderRow={(item) =>
        ...
        <CardItem>
          <Left>
            <Badge style={this.badgeColor(item.tag).item.tag}>
