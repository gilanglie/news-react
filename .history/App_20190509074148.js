...
export default class App extends Component{
  ...
  async componentDidMount(){ 
    const weatherData = await FetchData.getWeather();
    console.log('wet',weatherData)
  ...
  showWeather() {
    return (
      <View style={globalStyle.recentlyPlayed}>
        <Text style={[globalStyle.name, globalStyle.paddingLeftValue, globalStyle.mb10]}>{this.state.weatherData}</Text>
